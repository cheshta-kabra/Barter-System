                ...
                <View style={styles.modalContainer}>
                    <ScrollView style={{width:'100%'}}>
                         <KeyboardAvoidingView style={styles.keyboardAvoidingView}>
                             ...
                             placeholder='FIRST NAME' maxLength={15} onChangeText={(text)=>{
                                 this.setState({
                                     firstName:text
                                 })
                             }} />
                             ...
                             <TextInput style={styles.formTextInput} 
                             placeholder='LAST NAME' maxLength={15} onChangeText={(text)=>{
                                 this.setState({
                                     lastName:text
                                 })
                             }} />
                             ...
                             <TextInput style={styles.formTextInput} 
                             placeholder='CONTACT_NO' maxLength={10}  keyboardType={'numeric'} onChangeText={(text)=>{
                                 this.setState({
                                     contact:text
                                 })
                             }} />
    ...
    userSignUp = async(emailId,password,confirmPassword)=>{
        if(password !== confirmPassword){
            ...
            .then((response)=>{
                ...
                return Alert.alert('','User Added Successfully','',[{text:'ok',onPress:()=>{
                    this.setState({
                        isModalVisible:false
                    })
                }}])
    ...
    render(){
        return(
            <View style={styles.container}>
                ...
                <View><Text style={styles.title}> BarterSystem</Text></View>
...
container:{ flex:1, backgroundColor:'black',color:'red' }, 
